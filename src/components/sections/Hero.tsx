      ...
      <div className="relative z-10 container-custom text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center px-4 py-2 mb-8 mt-32 text-sm font-medium rounded-full bg-primary/10 text-primary border border-primary/20 backdrop-blur-sm"
          >
